...
from run_native_tp2 import patch_stock_rms_norm
...
def main():
    ...
    for dataset in args.datasets:
        ...
        if is_main:
            total_t = sum(r["end_to_end_s"] for r in results[1:])  # drop warmup
            total_tok = sum(r["n_tokens"] for r in results[1:])
